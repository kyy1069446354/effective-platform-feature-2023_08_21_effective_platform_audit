<template>
   <div class="app-container">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="90px">
         <el-form-item label="申请人姓名" prop="code">
			 <el-select
      ...
      <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
		  ...
		  <el-table-column label="申请单位" prop="name" align="center" :show-overflow-tooltip="true" width="150" />
		  <el-table-column label="申请人姓名" prop="code" align="center" :show-overflow-tooltip="true" width="150" />
		  <el-table-column label="申请原因" align="center" prop="orderNum" width="200" />


    <el-table-column label="申请详情" align="center" :show-overflow-tooltip="true">
       <template #default="scope">
         <el-button link type="primary" @click="handleDictData(scope.row)">{{ scope.row.code }}</el-button>
       </template>
    </el-table-column>
   
         <el-table-column label="审批状态" align="center" sortable prop="status" width="100">
            <template #default="scope">
         ...
         <el-table-column label="操作" align="center" width="160" class-name="small-padding fixed-width">
            <template #default="scope">
               <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermission="['system:dict:edit']">审批</el-button>
            </template>
         </el-table-column>
      ...
      <el-dialog :title="title" v-model="open" width="700px" append-to-body>
         <el-form ref="dataRef" :model="form" :rules="rules" label-width="100px">
			 <el-steps :active="2" align-center>
			   <el-step title="审批节点1" description="这是一段很长很长很长的描述性文字"></el-step>
			   <el-step title="审批节点2" description="这是一段很长很长很长的描述性文字"></el-step>
			   <el-step title="审批节点3" description="这是一段很长很长很长的描述性文字"></el-step>
			   <el-step title="审批节点4" description="这是一段很长很长很长的描述性文字"></el-step>
			 </el-steps>
          ...
          <el-form-item label="审批意见一" prop="dictLabel">
               <el-input v-model="form.label" placeholder="请输入数据标签" />
            </el-form-item>
			<el-form-item label="审批意见二" prop="dictLabel">
			     <el-input v-model="form.label" placeholder="请输入数据标签" />
			  </el-form-item>
         ...
         <template #footer>
            <div class="dialog-footer">
			   ...
			   <el-button type="danger" @click="submitForm">拒 绝</el-button>
