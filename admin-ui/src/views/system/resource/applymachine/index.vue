  ...
  <div class="app-container">
   ...
   <el-card class="form-card">
    ...
    <el-form :model="queryParams" ref="queryRef" :rules="rules" v-show="showSearch" :inline="true">
      ...
      <el-form-item label="系统负责人" prop="code" required>
        <el-input
	  ...
	  <el-form-item label="联系方式" prop="code" required>
	    <el-input
	      v-model="queryParams.code"
	      placeholder="请输入联系电话"
	      clearable
	  ...
	  <el-form-item label="系统使用人员" prop="name" required>
	    <el-input
	      v-model="queryParams.name"
	      placeholder="请输入邮箱"
	      clearable
	  ...
	  <el-form-item label="业务访问方式" prop="name" required>
	    <el-input
	      v-model="queryParams.name"
	      placeholder="请输入邮箱"
	      clearable
	  ...
	  <el-form-item label="待安装的操作系统版本" prop="name" required>
	    <el-input
	      v-model="queryParams.name"
	      placeholder="请输入邮箱"
	      clearable
	  ...
	  <el-form-item label="待安装的中间件版本" prop="name" required>
	    <el-input
	      v-model="queryParams.name"
	      placeholder="请输入邮箱"
	      clearable
	  ...
	  <el-form-item label="待安装的数据库版本" prop="name" required>
	    <el-input
	      v-model="queryParams.name"
	      placeholder="请输入邮箱"
	      clearable
	  ...
	  <el-form-item label="资源需求情况" prop="name" required>
	    <el-input
	      v-model="queryParams.name"
	      placeholder="请输入邮箱"
	      clearable
	  ...
	  <el-form-item label="CPU数量" prop="name" required>
	    <el-input
	      v-model="queryParams.name"
	      placeholder="请输入邮箱"
	      clearable
	  ...
	  <el-form-item label="内存数量(单位:G)" prop="code" required>
	    <el-input
	      v-model="queryParams.code"
	      placeholder="请输入申请原因"
	      clearable
	  ...
	  <el-form-item label="磁盘空间(单位:G)" prop="name" required>
	    <el-input
	      v-model="queryParams.name"
	      placeholder="请输入邮箱"
	      clearable
...
<el-row :gutter="10" class="mb8" justify="end">
  <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="申请单位名称" prop="name" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="申请人姓名" prop="code" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="申请原因" prop="orderNum" width="100" />
          <el-table-column prop="status" label="申请状态"  sortable width="100">
